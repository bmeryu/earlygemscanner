document.addEventListener('DOMContentLoaded', () => {
    // --- Elementos del DOM ---
    const fetchDataBtn = document.getElementById('fetchDataBtn'); // el botón "Buscar gemas"
    ...
    // acá guardaremos lo que vuelva del backend
    let currentTokens = [];
    ...
    if (fetchDataBtn) {
        ...
        console.error('No encontré el botón con id="fetchDataBtn"');
    }
    ...
    async function loadAndRenderTokens() {
        ...
        // ojo: tu select de “edad del pool” tal vez tiene texto, así que usa .value numérico en el HTML
        const poolAge = document.getElementById('poolAge').value;
        ...
        try {
            // 3. llamar al backend con los filtros
